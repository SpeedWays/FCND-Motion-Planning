...
from planning_utils_search_grid import a_star, heuristic, create_grid, prune_path
    ...
    def search_path(self):
        ...
        def onclick(event):
            ...
            if len(coords) == 1:
                ...
                fig.canvas.draw()
                grid_start = (x, y)
                print('Select on grid a destination point ...')
        ...
        print('Select on grid a starting point ...')
